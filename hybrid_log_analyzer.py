#!/usr/bin/env python3
# ============================================================
# SELF-LEARNING HYBRID LOG ANALYZER (FINAL CLEAN RESEARCH VERSION)
# Rule → ML fallback → Auto rule learning
# ML OUTPUT = ONLY ATTACK DECISION
# ============================================================
    ...
    try:
        with open(RULE_FILE, "r", encoding="utf-8") as f:
            for line in f:
                ...
                remedy = parts[4] if len(parts) > 4 else \
...
def hybrid_analyze_log(log_line, features):
    ...
    # ---------- ML FALLBACK ----------
    confidence, ml_time = ml_detect(features)
